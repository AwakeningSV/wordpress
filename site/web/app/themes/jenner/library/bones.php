...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    // register main stylesheet
    wp_register_style( 'bones-stylesheet', get_stylesheet_directory_uri() . '/build/all.css', array(), '', 'all' );
...
function bones_menu_class() {
    $pure_classes = 'pure-menu pure-menu-open pure-menu-horizontal pure-menu-children';
    $menu_classes = 'nav ' . $pure_classes . ' top-nav clearfix';
    return $menu_classes;
}
...
function bones_main_nav() {
    ...
    wp_nav_menu(array(
		...
		'menu_class' => bones_menu_class(),         // adding custom nav class
